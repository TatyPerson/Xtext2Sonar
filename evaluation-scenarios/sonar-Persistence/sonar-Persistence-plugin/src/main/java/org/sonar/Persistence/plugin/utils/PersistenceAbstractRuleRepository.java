 ...
 * {@inheritDoc}
 */
public abstract class PersistenceAbstractRuleRepository implements RulesDefinition {
   ...
   * {@inheritDoc}
   */
  public PersistenceAbstractRuleRepository(ServerFileSystem fileSystem, RulesDefinitionXmlLoader xmlRuleLoader, Settings settings, String key, String name, String customKey) {
  ...
  public void define(Context context) {
    NewRepository repository = context.createRepository(repositoryKey, PersistenceLanguage.KEY).setName(repositoryName);
