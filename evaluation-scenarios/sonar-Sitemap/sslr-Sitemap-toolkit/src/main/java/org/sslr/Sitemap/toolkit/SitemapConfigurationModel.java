...
public class SitemapConfigurationModel extends AbstractConfigurationModel {

  private static final Logger LOG = LoggerFactory.getLogger(SitemapConfigurationModel.class);
  ...
  public Parser<? extends Grammar> doGetParser() {
    ...
    return SitemapParser.create(context, getConfiguration());
  }
  ...
  public List<Tokenizer> doGetTokenizers() {
    return ImmutableList.of(
      ...
      new KeywordsTokenizer("<span class=\"k\">", "</span>", SitemapKeyword.keywordValues()));
  }

  @VisibleForTesting
  SitemapConfiguration getConfiguration() {
    SitemapConfiguration config = new SitemapConfiguration(getCharset());
