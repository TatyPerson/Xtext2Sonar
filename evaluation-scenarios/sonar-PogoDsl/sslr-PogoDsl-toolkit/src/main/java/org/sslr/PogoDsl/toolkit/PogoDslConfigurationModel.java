...
public class PogoDslConfigurationModel extends AbstractConfigurationModel {

  private static final Logger LOG = LoggerFactory.getLogger(PogoDslConfigurationModel.class);
  ...
  public Parser<? extends Grammar> doGetParser() {
    ...
    return PogoDslParser.create(context, getConfiguration());
  }
  ...
  public List<Tokenizer> doGetTokenizers() {
    return ImmutableList.of(
      ...
      new KeywordsTokenizer("<span class=\"k\">", "</span>", PogoDslKeyword.keywordValues()));
  }

  @VisibleForTesting
  PogoDslConfiguration getConfiguration() {
    PogoDslConfiguration config = new PogoDslConfiguration(getCharset());
