 ...
 * {@inheritDoc}
 */
public abstract class PogoDslAbstractRuleRepository implements RulesDefinition {
   ...
   * {@inheritDoc}
   */
  public PogoDslAbstractRuleRepository(ServerFileSystem fileSystem, RulesDefinitionXmlLoader xmlRuleLoader, Settings settings, String key, String name, String customKey) {
  ...
  public void define(Context context) {
    NewRepository repository = context.createRepository(repositoryKey, PogoDslLanguage.KEY).setName(repositoryName);
