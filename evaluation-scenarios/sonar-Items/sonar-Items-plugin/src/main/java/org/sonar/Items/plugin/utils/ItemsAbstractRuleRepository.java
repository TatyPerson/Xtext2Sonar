 ...
 * {@inheritDoc}
 */
public abstract class ItemsAbstractRuleRepository implements RulesDefinition {
   ...
   * {@inheritDoc}
   */
  public ItemsAbstractRuleRepository(ServerFileSystem fileSystem, RulesDefinitionXmlLoader xmlRuleLoader, Settings settings, String key, String name, String customKey) {
  ...
  public void define(Context context) {
    NewRepository repository = context.createRepository(repositoryKey, ItemsLanguage.KEY).setName(repositoryName);
