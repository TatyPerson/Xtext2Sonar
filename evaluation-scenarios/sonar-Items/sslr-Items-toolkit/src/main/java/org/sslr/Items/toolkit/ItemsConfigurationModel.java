...
public class ItemsConfigurationModel extends AbstractConfigurationModel {

  private static final Logger LOG = LoggerFactory.getLogger(ItemsConfigurationModel.class);
  ...
  public Parser<? extends Grammar> doGetParser() {
    ...
    return ItemsParser.create(context, getConfiguration());
  }
  ...
  public List<Tokenizer> doGetTokenizers() {
    return ImmutableList.of(
      ...
      new KeywordsTokenizer("<span class=\"k\">", "</span>", ItemsKeyword.keywordValues()));
  }

  @VisibleForTesting
  ItemsConfiguration getConfiguration() {
    ItemsConfiguration config = new ItemsConfiguration(getCharset());
