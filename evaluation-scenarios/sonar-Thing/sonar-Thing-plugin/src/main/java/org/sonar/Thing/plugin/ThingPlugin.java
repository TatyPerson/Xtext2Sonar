...
import org.sonar.Thing.plugin.coverage.ThingCoverageSensor;
import org.sonar.Thing.plugin.externalrules.ThingExternalRuleRepository;
import org.sonar.Thing.plugin.externalrules.ThingExternalRulesSensor;
import org.sonar.Thing.plugin.squid.ThingSquidSensor;
import org.sonar.Thing.plugin.utils.ThingMetrics;
import org.sonar.Thing.plugin.xunit.ThingXunitSensor;
 ...
 * {@inheritDoc}
 */
public final class ThingPlugin extends SonarPlugin {
  static final String SOURCE_FILE_SUFFIXES_KEY = "sonar.thing.suffixes.sources";
  public static final String FILE_SUFFIXES_DEFVALUE = ".things";
  public static final String HEADER_FILE_SUFFIXES_KEY = "sonar.thing.suffixes.headers";
  public static final String DEFINES_KEY = "sonar.thing.defines";  
  public static final String INCLUDE_DIRECTORIES_KEY = "sonar.thing.includeDirectories";
  public static final String ERROR_RECOVERY_KEY = "sonar.thing.errorRecoveryEnabled";
  public static final String FORCE_INCLUDE_FILES_KEY = "sonar.thing.forceIncludes";
  public static final String MISSING_INCLUDE_WARN = "sonar.thing.missingIncludeWarnings";
  ...
  private static List<PropertyDefinition> generalProperties() {
    ...
    return ImmutableList.of(
      ...
      .defaultValue(ThingLanguage.DEFAULT_FILE_SUFFIXES)
      ...
      PropertyDefinition.builder(ThingPlugin.ERROR_RECOVERY_KEY)
      .defaultValue("False")
      ...
      .index(7)              
      .build(),
      PropertyDefinition.builder(ThingPlugin.MISSING_INCLUDE_WARN)
      .defaultValue("True")
	  ...
	  private static List<PropertyDefinition> testingAndCoverageProperties() {
	    ...
	    return ImmutableList.of(
	      PropertyDefinition.builder(ThingXunitSensor.REPORT_PATH_KEY)
	      ...
	      PropertyDefinition.builder(ThingXunitSensor.XSLT_URL_KEY)
	      ...
	      PropertyDefinition.builder(ThingXunitSensor.PROVIDE_DETAILS_KEY)
  ...
  public List<Object> getExtensions() {
    ...
    l.add(ThingLanguage.class);
    l.add(ThingMetrics.class);
    l.add(ThingSquidSensor.class);
    l.add(ThingCpdMapping.class);
    l.add(ThingXunitSensor.class);
    l.add(ThingCoverageSensor.class);
    l.add(ThingDefaultProfile.class);
    l.add(ThingCommonRulesEngine.class);
    l.add(ThingCommonRulesDecorator.class);
    l.add(ThingRuleRepository.class);
    l.add(ThingExternalRulesSensor.class);
    l.add(ThingExternalRuleRepository.class);
