 ...
 * {@inheritDoc}
 */
public abstract class ThingAbstractRuleRepository implements RulesDefinition {
   ...
   * {@inheritDoc}
   */
  public ThingAbstractRuleRepository(ServerFileSystem fileSystem, RulesDefinitionXmlLoader xmlRuleLoader, Settings settings, String key, String name, String customKey) {
  ...
  public void define(Context context) {
    NewRepository repository = context.createRepository(repositoryKey, ThingLanguage.KEY).setName(repositoryName);
