 ...
 */
public class ThingLinesOfCodeVisitor<GRAMMAR extends Grammar> extends SquidAstVisitor<GRAMMAR> implements AstAndTokenVisitor {

  private final MetricDef metric;
  private int lastTokenLine;

  public ThingLinesOfCodeVisitor(MetricDef metric) {
    this.metric = metric;
  }
