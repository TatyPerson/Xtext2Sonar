 ...
 */
public class VaryGrammarLinesOfCodeVisitor<GRAMMAR extends Grammar> extends SquidAstVisitor<GRAMMAR> implements AstAndTokenVisitor {

  private final MetricDef metric;
  private int lastTokenLine;

  public VaryGrammarLinesOfCodeVisitor(MetricDef metric) {
    this.metric = metric;
  }
