...
public class VaryGrammarConfigurationModel extends AbstractConfigurationModel {

  private static final Logger LOG = LoggerFactory.getLogger(VaryGrammarConfigurationModel.class);
  ...
  public Parser<? extends Grammar> doGetParser() {
    ...
    return VaryGrammarParser.create(context, getConfiguration());
  }
  ...
  public List<Tokenizer> doGetTokenizers() {
    return ImmutableList.of(
      ...
      new KeywordsTokenizer("<span class=\"k\">", "</span>", VaryGrammarKeyword.keywordValues()));
  }

  @VisibleForTesting
  VaryGrammarConfiguration getConfiguration() {
    VaryGrammarConfiguration config = new VaryGrammarConfiguration(getCharset());
