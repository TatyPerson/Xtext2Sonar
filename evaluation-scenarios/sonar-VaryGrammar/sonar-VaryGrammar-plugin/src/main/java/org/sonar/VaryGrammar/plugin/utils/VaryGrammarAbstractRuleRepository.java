 ...
 * {@inheritDoc}
 */
public abstract class VaryGrammarAbstractRuleRepository implements RulesDefinition {
   ...
   * {@inheritDoc}
   */
  public VaryGrammarAbstractRuleRepository(ServerFileSystem fileSystem, RulesDefinitionXmlLoader xmlRuleLoader, Settings settings, String key, String name, String customKey) {
  ...
  public void define(Context context) {
    NewRepository repository = context.createRepository(repositoryKey, VaryGrammarLanguage.KEY).setName(repositoryName);
