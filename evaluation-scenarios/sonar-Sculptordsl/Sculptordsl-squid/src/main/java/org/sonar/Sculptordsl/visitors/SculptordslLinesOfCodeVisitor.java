 ...
 */
public class SculptordslLinesOfCodeVisitor<GRAMMAR extends Grammar> extends SquidAstVisitor<GRAMMAR> implements AstAndTokenVisitor {

  private final MetricDef metric;
  private int lastTokenLine;

  public SculptordslLinesOfCodeVisitor(MetricDef metric) {
    this.metric = metric;
  }
