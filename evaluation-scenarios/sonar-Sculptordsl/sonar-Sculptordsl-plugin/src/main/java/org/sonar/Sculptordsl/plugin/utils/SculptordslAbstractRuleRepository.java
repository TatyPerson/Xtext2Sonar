 ...
 * {@inheritDoc}
 */
public abstract class SculptordslAbstractRuleRepository implements RulesDefinition {
   ...
   * {@inheritDoc}
   */
  public SculptordslAbstractRuleRepository(ServerFileSystem fileSystem, RulesDefinitionXmlLoader xmlRuleLoader, Settings settings, String key, String name, String customKey) {
  ...
  public void define(Context context) {
    NewRepository repository = context.createRepository(repositoryKey, SculptordslLanguage.KEY).setName(repositoryName);
