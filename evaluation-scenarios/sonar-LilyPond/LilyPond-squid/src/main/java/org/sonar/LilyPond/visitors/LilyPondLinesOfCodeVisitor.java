 ...
 */
public class LilyPondLinesOfCodeVisitor<GRAMMAR extends Grammar> extends SquidAstVisitor<GRAMMAR> implements AstAndTokenVisitor {

  private final MetricDef metric;
  private int lastTokenLine;

  public LilyPondLinesOfCodeVisitor(MetricDef metric) {
    this.metric = metric;
  }
