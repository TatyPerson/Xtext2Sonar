 ...
 * {@inheritDoc}
 */
public abstract class LilyPondAbstractRuleRepository implements RulesDefinition {
   ...
   * {@inheritDoc}
   */
  public LilyPondAbstractRuleRepository(ServerFileSystem fileSystem, RulesDefinitionXmlLoader xmlRuleLoader, Settings settings, String key, String name, String customKey) {
  ...
  public void define(Context context) {
    NewRepository repository = context.createRepository(repositoryKey, LilyPondLanguage.KEY).setName(repositoryName);
