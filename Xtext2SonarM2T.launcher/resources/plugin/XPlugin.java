...
import org.sonar.NAME.plugin.coverage.NAMECoverageSensor;
import org.sonar.NAME.plugin.externalrules.NAMEExternalRuleRepository;
import org.sonar.NAME.plugin.externalrules.NAMEExternalRulesSensor;
import org.sonar.NAME.plugin.squid.NAMESquidSensor;
import org.sonar.NAME.plugin.utils.NAMEMetrics;
import org.sonar.NAME.plugin.xunit.NAMEXunitSensor;
 ...
 * {@inheritDoc}
 */
public final class NAMEPlugin extends SonarPlugin {
  static final String SOURCE_FILE_SUFFIXES_KEY = "sonar.LOWER.suffixes.sources";
  public static final String FILE_SUFFIXES_DEFVALUE = ".LOWER";
  public static final String HEADER_FILE_SUFFIXES_KEY = "sonar.LOWER.suffixes.headers";
  public static final String DEFINES_KEY = "sonar.LOWER.defines";  
  public static final String INCLUDE_DIRECTORIES_KEY = "sonar.LOWER.includeDirectories";
  public static final String ERROR_RECOVERY_KEY = "sonar.LOWER.errorRecoveryEnabled";
  public static final String FORCE_INCLUDE_FILES_KEY = "sonar.LOWER.forceIncludes";
  public static final String MISSING_INCLUDE_WARN = "sonar.LOWER.missingIncludeWarnings";
  ...
  private static List<PropertyDefinition> generalProperties() {
    ...
    return ImmutableList.of(
      ...
      .defaultValue(NAMELanguage.DEFAULT_FILE_SUFFIXES)
      ...
      PropertyDefinition.builder(NAMEPlugin.ERROR_RECOVERY_KEY)
      .defaultValue("False")
      ...
      .index(7)              
      .build(),
      PropertyDefinition.builder(NAMEPlugin.MISSING_INCLUDE_WARN)
      .defaultValue("True")
	  ...
	  private static List<PropertyDefinition> testingAndCoverageProperties() {
	    ...
	    return ImmutableList.of(
	      PropertyDefinition.builder(NAMEXunitSensor.REPORT_PATH_KEY)
	      ...
	      PropertyDefinition.builder(NAMEXunitSensor.XSLT_URL_KEY)
	      ...
	      PropertyDefinition.builder(NAMEXunitSensor.PROVIDE_DETAILS_KEY)
  ...
  public List<Object> getExtensions() {
    ...
    l.add(NAMELanguage.class);
    l.add(NAMEMetrics.class);
    l.add(NAMESquidSensor.class);
    l.add(NAMECpdMapping.class);
    l.add(NAMEXunitSensor.class);
    l.add(NAMECoverageSensor.class);
    l.add(NAMEDefaultProfile.class);
    l.add(NAMECommonRulesEngine.class);
    l.add(NAMECommonRulesDecorator.class);
    l.add(NAMERuleRepository.class);
    l.add(NAMEExternalRulesSensor.class);
    l.add(NAMEExternalRuleRepository.class);
